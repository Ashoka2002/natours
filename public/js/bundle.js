...
},{"axios":"../../node_modules/axios/index.js"}],"leaflet.js":[function(require,module,exports) {
"use strict";
...
function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    L.marker([loc.coordinates[1], loc.coordinates[0]], {}).addTo(map).bindPopup("<p style={font-size: \"20px\"}>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
      autoClose: false
    }).openPopup();
  });
...
},{"./login":"login.js","./leaflet":"leaflet.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
